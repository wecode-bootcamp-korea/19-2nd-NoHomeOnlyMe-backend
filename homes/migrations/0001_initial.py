    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dong', models.CharField(max_length=10, null=True)),
                ('ho', models.CharField(max_length=10, null=True)),
                ('latitude', models.DecimalField(decimal_places=10, max_digits=15)),
                ('longitude', models.DecimalField(decimal_places=10, max_digits=15)),
        ...
        migrations.AddField(
            model_name='home',
            name='house_type',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='homes.housetype'),
        ),
        migrations.AddField(
            model_name='home',
            name='legalcode',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='homes.dongtype'),
        ),
        migrations.AddField(
            model_name='home',
            name='room_type',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='homes.roomtype'),
        ),
        migrations.AddField(
            model_name='dongtype',
            name='gu_type',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='homes.gutype'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional_information', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='homes.additionalinformation')),
                ('additional_option', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='homes.additionaloption')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('additional_information', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='homes.additionalinformation')),
                ('room_option', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='homes.roomoption')),
            ],
            options={
